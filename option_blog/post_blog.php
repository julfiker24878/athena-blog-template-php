...
$tags = mysqli_real_escape_string($db_connect, $_POST['tags']);
...
if (in_array($extension, $allowed_extension)) {
	if($blog_image['size'] < 19000000){
		$insert = "INSERT INTO blogs(title, des, category, tags, posted_at) VALUES('$title','$des', '$category', '$tags', '$posted_at')";
