                        ...
                        <div class="card">
                            <div class="card-header d-sm-flex d-block pb-0 border-0">
                                <div class="mr-auto pr-3">
                                    ...
                                    <p class="fs-13 mb-0 text-black">Backend developed by <a href="https://julfikerali.com/" target="_blank" class="text-success"> <strong>Julfiker Ali</strong> </a></p>
                                </div>
                                <a href="./users/view_users.php" class="btn btn-primary rounded d-none d-md-block">View More</a>
                            </div>
                                ...
                                <?php foreach($users_query as $user){ ?>
                                    <div class="items">
                                        <div class="card text-center">
                                            <div class="card-body">
                                                <img src="/athena/users/uploads/profile/<?= $user['profile_image']; ?>" alt="profile-image">
